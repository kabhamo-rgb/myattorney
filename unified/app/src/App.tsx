        ...
        <section id="terms" className="section legal-section">
          ...
          <div className="legal-body">
            ...
            <p><strong>{__t("תמחור (כולל מע״מ):")}</strong>{" " + __t(
              "בדיקת/החזר עיקול — ללא עלות; שכר טרחה מותנה הצלחה 25% בתוספת מע״מ, מכל סכום שיושב בפועל בלבד («ללא זכייה — אין תשלום»). הכנת טפסים: ₪190 לטופס בודד, ₪490 לסט הוצאה לפועל (המחירים כוללים מע״מ). אגרות והוצאות חיצוניות אינן כלולות ויחולו על הלקוח בנפרד."
            )}</p>
