...
const faqs = [
  ...
  },
  {
    ...
    answer: __t(
      "לא. הכלי מבצע מיון ראשוני בלבד המבוסס על מאגרים ציבוריים רשמיים, ואינו קובע זכאות או מבטיח תוצאה. תשובה מותאמת נבדקת על ידי עו״ד מוחמד קבהא (מ.ר 67912) לפני כל פעולה."
    ),
  },
  {
      ...
      <main>
        <section id="legal-tool" className="hero-tool section">
          <div className="hero-tool-intro">
            ...
            <p className="hero-text">{__t("המערכת מבצעת") + " "}<strong>{__t("מיון טכנולוגי ראשוני")}</strong>{" " + __t(
              ...
              "— תשובה מותאמת נבדקת על ידי עו״ד מוחמד מ׳ קבהא (מ.ר 67912) לפני כל פעולה."
            )}</p>
        ...
        <section id="services" className="section services-section">
          <div className="section-header">
            ...
            <h2>{__t("מומחיות ממוקדת: עיקולים, גביית־יתר והחזרים")}</h2>
          </div>
