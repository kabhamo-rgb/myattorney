...
const faqs = [
  ...
  {
    question: 'עיקלו לי כסף מחשבון הבנק — מה עושים?',
    answer: 'עיקול חשבון בנק יכול לתפוס כספים בחשבון, אך חלק מהכספים מוגנים מעיקול — למשל קצבאות ביטוח לאומי, דמי מזונות ושכר עד תקרה מסוימת. אם עוקלו כספים מוגנים, או שהעיקול חורג מהחוב האמיתי, ייתכן שמגיע לך החזר. כדאי לבדוק את פירוט העיקול מול הזכויות המוגנות — הבדיקה הראשונית אצלנו חינמית.',
  },
  {
    question: 'עיקול משכורת — כמה מותר לעקל?',
    answer: 'החוק בישראל מגן על חלק מהשכר: קיים סכום מינימלי (המבוסס על רמת קיום בסיסית ומספר התלויים) שאסור לעקל. עיקול שחורג מהתקרה המותרת — ניתן לעיתים להשבה. הבדיקה החינמית עוזרת לזהות אם עוקל יותר מהמותר על פי דין.',
  },
  {
    question: 'עיקול בהוצאה לפועל — איך יודעים אם גבו לי יותר מדי?',
    answer: 'בודקים את יתרת החוב המקורי מול הסכום שנגבה בפועל, כולל ריבית והוצאות. טעויות נפוצות: ריבית שחושבה שגוי, כפל חיוב, גבייה אחרי שהחוב כבר סולק, או עיקול על כספים מוגנים. מחשבון הבדיקה שלנו נותן אינדיקציה ראשונית תוך דקה, ללא עלות וללא התחייבות.',
  },
  {
    question: 'כמה זמן לוקח לקבל החזר על גבייה ביתר?',
    answer: 'אין פרק זמן אחיד — התהליך תלוי בסוג התיק, בהיקף הבדיקה ובתגובת הגורמים המעורבים (הוצאה לפועל, הזוכה). המשרד פועל לקדם את התהליך ולעדכן על ההתקדמות, אך לא ניתן להתחייב מראש על מועד או על תוצאה.',
  },
  {
      ...
      <main>
        <section id="legal-tool" className="hero-tool section">
          <div className="hero-tool-intro">
            <p className="eyebrow">בדיקה ראשונית חינמית • אינו ייעוץ משפטי</p>
            <h1>האם עוקלו לך כספים? אולי מגיע לך החזר.</h1>
          ...
          <div className="tool-card">
            ...
            {heroTab === 'garnish' && (
              <form className="tool-form garnish-form" onSubmit={handleGarnishSubmit}>
                <p className="garnish-lead">מלא 3 פרטים ותגלה תוך דקה אם מגיע לך כסף בחזרה:</p>
                <div className="garnish-grid">
